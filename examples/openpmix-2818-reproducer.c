...
/**
 * Create a pset with the process
 */
static void createPSet(const char *nspace)
{
    pmix_proc_t members[1];
    
    PMIX_PROC_LOAD(members, nspace, 0);

    pmix_status_t status = PMIx_server_define_process_set(members, 1, "pset0");
	...
	printf("failed to create process set: %s (%d)\n",
